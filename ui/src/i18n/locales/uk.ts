...
export const uk: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "Інкогніто",
    incognitoDescription: "Зберігати цей ланцюжок лише до перезапуску Gateway",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Цей застарілий браузер тимчасово залишається доступним. Знову відкрийте його через HTTPS або localhost, щоб захистити його ідентифікацією пристрою.",
  ...
  chat: {
    ...
    sessionSharing: {
      menu: "Спільний доступ до ланцюжка",
      current: "Видимість ланцюжка: {visibility}",
      ...
      readOnlyNotice: "Лише власник і учасники гілки можуть діяти в цій гілці.",
    },
