...
export const vi: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "Ẩn danh",
    incognitoDescription: "Chỉ giữ luồng này cho đến khi Gateway khởi động lại",
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Chỉ chủ sở hữu và thành viên của luồng mới có thể thao tác trong luồng này.",
    },
    ...
    composer: {
      ...
      offlineQueuedHint:
        "Ngoại tuyến — {count} đang chờ; tin nhắn sẽ gửi khi kết nối được khôi phục.",
