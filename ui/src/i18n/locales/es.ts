...
export const es: TranslationMap = {
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner:
        "Este navegador aún necesita aprobación única del dispositivo después de la actualización.",
      action: "Asegurar este navegador",
      secureContextRequired:
        "Este navegador heredado sigue disponible temporalmente. Vuelve a abrirlo por HTTPS o localhost para asegurarlo con la identidad del dispositivo.",
      pendingUnavailable:
      ...
      approvalFailed: "No se pudo asegurar este navegador: {error}",
    },
