...
export const id: TranslationMap = {
  ...
  sessionsView: {
    ...
    approvalNeeded: "Perlu persetujuan",
    queuedMessage: "{count} pesan diantrekan untuk dikirim",
    queuedMessages: "{count} pesan diantrekan untuk dikirim",
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "Peramban ini masih memerlukan persetujuan perangkat sekali pakai setelah pembaruan.",
      action: "Amankan peramban ini",
      secureContextRequired:
        "Peramban lawas ini tetap tersedia untuk sementara. Buka kembali melalui HTTPS atau localhost untuk mengamankannya dengan identitas perangkat.",
      pendingUnavailable: "Permintaan penyandingan peramban belum tersedia. Coba lagi sebentar.",
      loadFailed: "Tidak dapat memuat permintaan penyandingan peramban ini: {error}",
      approvalFailed: "Tidak dapat mengamankan peramban ini: {error}",
    },
  ...
  chat: {
    ...
    sessionSharing: {
      menu: "Pembagian utas",
      current: "Visibilitas utas: {visibility}",
      ...
      members: "Anggota",
      selected: "Anggota",
      noPeople: "Tidak ada orang yang dipasangkan ditemukan.",
      readOnlyNotice: "Hanya pemilik dan anggota thread yang dapat bertindak di thread ini.",
    },
