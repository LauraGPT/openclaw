...
export const fa: TranslationMap = {
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "این مرورگر قدیمی به‌طور موقت در دسترس باقی می‌ماند. آن را از طریق HTTPS یا localhost دوباره باز کنید تا با هویت دستگاه ایمن شود.",
      ...
      approvalFailed: "این مرورگر ایمن نشد: {error}",
    },
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      current: "قابلیت مشاهده گفتگو: {visibility}",
      ...
      readOnlyNotice: "فقط مالک و اعضای گفتگو می‌توانند در این گفتگو اقدام کنند.",
    },
