...
export const ko: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "시크릿",
    incognitoDescription: "Gateway가 재시작될 때까지만 이 스레드를 유지합니다",
  ...
  sessionsView: {
    ...
    approvalNeeded: "승인 필요",
    queuedMessage: "메시지 {count}개 전송 대기 중",
    queuedMessages: "메시지 {count}개 전송 대기 중",
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "업데이트 후 이 브라우저는 일회성 기기 승인이 필요합니다.",
      action: "이 브라우저 보안 설정",
      secureContextRequired:
        "이 레거시 브라우저는 일시적으로 계속 사용할 수 있습니다. 기기 신원으로 보안을 설정하려면 HTTPS 또는 localhost에서 다시 여세요.",
      pendingUnavailable:
  ...
  chat: {
    ...
    composer: {
      ...
      offlineQueuedHint: "오프라인 — {count}개 대기 중이며, 연결이 복구되면 메시지가 전송됩니다.",
